...
while : ;do
    ...
    MAP_DIR="$HOME/robotbase_ws/maps_waypoints/maps/rtabmap_$map_name"
    mkdir -p "$MAP_DIR"
...
PYEOF
    ...
    COLORIZER_SCRIPT="$HOME/robotbase_ws/src/sirius/sirius_navigation/sirius_navigation/sam3_map_colorizer.py"
