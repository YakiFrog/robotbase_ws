...
# ROS2ワークスペースのソース
if [ -f "$HOME/robotbase_ws/install/setup.bash" ]; then
    source "$HOME/robotbase_ws/install/setup.bash"
    echo "ROS2ワークスペースをソースしました ($HOME/robotbase_ws)"
elif [ -f "$HOME/sirius_jazzy_ws/install/setup.bash" ]; then
    source "$HOME/sirius_jazzy_ws/install/setup.bash"
    echo "ROS2ワークスペースをソースしました ($HOME/sirius_jazzy_ws)"
else
